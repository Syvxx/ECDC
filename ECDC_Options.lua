...
function ECDC_CreateOptionsMenu()
	...
	category, layout = Settings.RegisterCanvasLayoutCategory(addon.panel, addon.panel.name, addon.panel.name);
	category.ID = addon.panel.name
	...
	for class,spells in pairsByKeys(classPanels) do
		...
		category, layout = Settings.RegisterCanvasLayoutCategory(addon.subpanel, addon.subpanel.name, addon.subpanel.name);
		category.ID = addon.subpanel.name
		Settings.RegisterAddOnCategory(addon.subpanel);
